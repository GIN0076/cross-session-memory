...
<div class="icon-grid">
  <div>
    ...
    <p><b>BỀN VỮNG</b>văn bản thuần lưu trên đĩa</p>
  </div>
  <div>
    ...
    <p><b>DỄ TRUY XUẤT</b>tìm kiếm IDF 3 hướng</p>
  </div>
  <div>
    ...
    <p><b>ĐƯỢC KIỂM CHỨNG</b>chuỗi bằng chứng bắt buộc</p>
  </div>
  <div>
    ...
    <p><b>TỰ ĐỘNG TIÊM</b>≤2KB mỗi phiên</p>
  </div>
  <div>
